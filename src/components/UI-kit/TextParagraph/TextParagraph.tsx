function TextParagraph() {
    return (
        <p className='ui-text-paragraph'>
            ...
            position and state before the animation begins, giving the user a clear idea of how the
            animation will appear. The preview button on the top panel will open the result in a new
            tab.
        </p>
    )
}
